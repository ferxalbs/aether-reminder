...
export function staticCeilingFromCapabilities(
  ...
  if (
    !capabilities.nativeTelemetryAvailable &&
    capabilities.lowRamDevice == null
  ) {
...
export function conservativeCapabilities(
  platform: NativeMotionCapabilities["platform"] = "unknown",
