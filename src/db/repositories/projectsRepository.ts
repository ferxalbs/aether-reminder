...
export class ProjectsRepository {
  ...
  async create(input: { name: string; color?: string | null; id?: string }): Promise<Project> {
    ...
    if (!project) throw new DatabaseError('QUERY_FAILED', 'Project insert verification failed.');
    return project;
  }
}
