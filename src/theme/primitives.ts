...
export const LayoutTokens = {
  ...
  /** Shared floating-chrome geometry; keeps navigation and composer controls aligned. */
  navigationHeight: 60,
  navigationItemHeight: 48,
  navigationIconSize: 19,
  navigationVoiceIconSize: 22,
  composerHeight: 56,
  composerControlSize: 44,
  composerActionSize: 36,
  composerIconSize: 20,
  composerActionIconSize: 18,
  sectionGap: 32,
...
export const ControlTokens = {
  ...
  fieldHeight: 44,
  fieldIconSize: 18,
  fieldIconStrokeWidth: 2,
  /** Shared icon metrics for product-owned toolbar and floating-chrome controls. */
  toolbarIconSize: 20,
  toolbarIconStrokeWidth: 2,
  navigationIconStrokeWidth: 1.8,
  navigationIconSelectedStrokeWidth: 2.3,
  navigationVoiceIconStrokeWidth: 2,
  composerIconStrokeWidth: 2.2,
  composerActionIconStrokeWidth: 2.8,
  disabledOpacity: 0.5,
